--  Matreshka / League version of the demo.
--  In Compiler: Runtime_Dep := Runtime_League.

with Ada.Streams.Stream_IO;
with Ada.Text_IO, Ada.Wide_Wide_Text_IO;
with League.Strings;  --  Matreshka / League library

with My_Format.Basics;
     --  ^ Generated by "protoc --ada_out=. basics.proto" (cf build_demo.cmd).

procedure Demo_League is

   procedure Show (p : My_Format.Basics.Person) is
      use Ada.Text_IO, League.Strings;
   begin
   ...
   begin
      ...
      Ada.Text_IO.Put_Line ("Useless_Symbol =" & c.Useless_Symbol'Image);

...
--   ^ Generated by "protoc --ada_out=. --ada_opt=runtime=plain_ada basics.proto".
...
procedure Demo is
   ...
   begin
      ...
      Put_Line ("JSON Representation: " & PB_Support.JSON.To_String (Writer));
      Put_Line
         (To_String (p.Name) &
          ", " &
   ...
   begin
      ...
      Ada.Text_IO.Put_Line
        ("JSON Representation: " & PB_Support.JSON.To_String (Writer));

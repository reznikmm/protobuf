...
with Google_Protobuf.OneofOptions;

package body Google_Protobuf.OneofDescriptorProto is
  ---------------------------------------------------------------------------
  --    Inherited functions and procedures from Google.Protobuf.Message    --
  ---------------------------------------------------------------------------

  procedure Clear (The_Message : in out Google_Protobuf.OneofDescriptorProto.Instance) is
  begin
  ...
  procedure Copy (To   : in out Google_Protobuf.OneofDescriptorProto.Instance;
                  From : in Google_Protobuf.OneofDescriptorProto.Instance) is
  begin
     To.Clear;
     To.Merge (From);
  end Copy;

  function Get_Type_Name (The_Message : in Google_Protobuf.OneofDescriptorProto.Instance) return Google.Protobuf.Wire_Format.PB_String is
  begin
     return "google.protobuf.OneofDescriptorProto";
  end Get_Type_Name;

  function Is_Initialized (The_Message : in Google_Protobuf.OneofDescriptorProto.Instance) return Boolean is
  begin
    if The_Message.Has_Options then
  ...
  procedure Merge (To : in out Google_Protobuf.OneofDescriptorProto.Instance; From : in Google_Protobuf.OneofDescriptorProto.Instance) is
  begin
  ...
  function Byte_Size (The_Message : in out Google_Protobuf.OneofDescriptorProto.Instance) return Google.Protobuf.Wire_Format.PB_Object_Size is
  ...
  begin
    ...
    -- optional .google.protobuf.OneofOptions options = 2;
    if The_Message.Has_Options then
      The_Coded_Output_Stream.Write_Message (2, The_Message.Options.all);
    end if;
  ...
  function Get_Cached_Size
     (The_Message : in Google_Protobuf.OneofDescriptorProto.Instance) return Google.Protobuf.Wire_Format.PB_Object_Size is
  begin
     return The_Message.Cached_Size;
  end Get_Cached_Size;

  overriding
  procedure Finalize (The_Message : in out Google_Protobuf.OneofDescriptorProto.Instance) is
  begin
    declare
       procedure Free is new Ada.Unchecked_Deallocation (Google.Protobuf.Wire_Format.PB_String, Google.Protobuf.Wire_Format.PB_String_Access);
    begin
  ...
  -- optional string name = 1;
  function Has_Name
     (The_Message : in OneofDescriptorProto.Instance) return Boolean is
  begin
     return (The_Message.Has_Bits(0) and 16#00000001#) /= 0;
  end Has_Name;

  procedure Set_Has_Name
     (The_Message : in out OneofDescriptorProto.Instance) is
  begin
  ...
  function Get_Name
     (The_Message : in OneofDescriptorProto.Instance) return Google.Protobuf.Wire_Format.PB_String is
  begin
  ...
  function Release_Name
     (The_Message : in out OneofDescriptorProto.Instance) return Google.Protobuf.Wire_Format.PB_String_Access is
  begin
     The_Message.Clear_Has_Name;
     if The_Message.Name = Google.Protobuf.Generated_Message_Utilities.EMPTY_STRING'Access then
        return null;
  ...
  function Get_Options (The_Message : in out OneofDescriptorProto.Instance) return access Google_Protobuf.OneofOptions.Instance is
     use type Google_Protobuf.OneofOptions.OneofOptions_Access;
  begin
     The_Message.Set_Has_Options;
     if The_Message.Options = null then
        The_Message.Options := Google_Protobuf.OneofOptions.OneofOptions_Access'(new Google_Protobuf.OneofOptions.Instance);
     end if;
     return The_Message.Options;
  end Get_Options;

  function Release_Options (The_Message : in out OneofDescriptorProto.Instance) return access Google_Protobuf.OneofOptions.Instance is
     Temp : access Google_Protobuf.OneofOptions.Instance;
  begin
     The_Message.Clear_Has_Options;
  ...
  procedure Set_Options
     (The_Message : in out OneofDescriptorProto.Instance;
      Value       : in Google_Protobuf.OneofOptions.OneofOptions_Access) is
     use type Google_Protobuf.OneofOptions.OneofOptions_Access;
     Temp : Google.Protobuf.Message.Instance_Access := Google.Protobuf.Message.Instance_Access (The_Message.Options);
  begin
     Google.Protobuf.Message.Free (Temp);

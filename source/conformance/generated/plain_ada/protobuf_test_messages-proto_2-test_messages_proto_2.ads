...
with PB_Support.Unbounded_String_Vectors;
...
package Protobuf_Test_Messages.Proto_2.Test_Messages_Proto_2 is
   ...
   package Test_All_Required_Types_Proto_2_Nested_Enum_Vectors is
     new PB_Support.Vectors (Test_All_Required_Types_Proto_2_Nested_Enum);
   ...
   type Map_String_String_Entry is
     record
        Key   : PB_Support.Unbounded_String_Vectors.Option;
        Value : PB_Support.Unbounded_String_Vectors.Option;
     end record;
   ...
   type Message_Set_Correct_Extension_1 is
     record
        Str : PB_Support.Unbounded_String_Vectors.Option;
     end record;
   ...
   type Message_Set_Correct_Extension_2 is
     record
        ...
        Sub_Msg : Protobuf_Test_Messages.Proto_2.Test_Messages_Proto_2
          .Optional_Message_Set_Correct;
     end record;
   ...
   type Unknown_To_Test_All_Types is
     record
        ...
        Optional_String : PB_Support.Unbounded_String_Vectors.Option;
   ...
   type One_String_Proto_2 is
     record
        Data : PB_Support.Unbounded_String_Vectors.Option;
     end record;
   ...
   type Proto_With_Keywords is
     record
        Inline   : PB_Support.Integer_32_Vectors.Option;
        Concept  : PB_Support.Unbounded_String_Vectors.Option;
        Requires : PB_Support.Unbounded_String_Vectors.Vector;
     end record;
     ...
     record
        case Oneof_Field is
           ...
           when Oneof_String_Kind =>
              Oneof_String : Ada.Strings.Unbounded.Unbounded_String;
           when Oneof_Bytes_Kind =>
              Oneof_Bytes : PB_Support.Basics.Stream_Element_Vector;
   ...
   type Test_All_Types_Proto_2 is
     record
        ...
        Optional_Bool              : PB_Support.Boolean_Vectors.Option;
        Optional_String            : PB_Support.Unbounded_String_Vectors
          .Option;
        ...
        Optional_String_Piece      : PB_Support.Unbounded_String_Vectors
          .Option;
        Optional_Cord              : PB_Support.Unbounded_String_Vectors
          .Option;
        ...
        Repeated_String            : PB_Support.Unbounded_String_Vectors
          .Vector;
        ...
        Repeated_String_Piece      : PB_Support.Unbounded_String_Vectors
          .Vector;
        Repeated_Cord              : PB_Support.Unbounded_String_Vectors
          .Vector;
        ...
        Default_String             : PB_Support.Unbounded_String_Vectors
          .Option;
   ...
   type Test_All_Required_Types_Proto_2 is
     record
        ...
        Required_String            : Ada.Strings.Unbounded.Unbounded_String;
        Required_Bytes             : PB_Support.Basics.Stream_Element_Vector;
        ...
        Required_String_Piece      : Ada.Strings.Unbounded.Unbounded_String;
        Required_Cord              : Ada.Strings.Unbounded.Unbounded_String;
        Recursive_Message          : Protobuf_Test_Messages.Proto_2
          .Test_Messages_Proto_2.Test_All_Required_Types_Proto_2_Vector;
        ...
        Default_String             : Ada.Strings.Unbounded.Unbounded_String;
        Default_Bytes              : PB_Support.Basics.Stream_Element_Vector;
     end record;

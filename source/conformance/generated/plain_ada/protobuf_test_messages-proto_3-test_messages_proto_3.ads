...
package Protobuf_Test_Messages.Proto_3.Test_Messages_Proto_3 is
   ...
   type Test_All_Types_Proto_3 is
     record
        ...
        Optional_String            : Ada.Strings.Unbounded.Unbounded_String;
        Optional_Bytes             : PB_Support.Basics.Stream_Element_Vector;
        ...
        Optional_String_Piece      : Ada.Strings.Unbounded.Unbounded_String;
        Optional_Cord              : Ada.Strings.Unbounded.Unbounded_String;
